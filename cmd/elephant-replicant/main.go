...
func main() {
	...
	runCmd := cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringSliceFlag{
				Name:    "ignore-creators",
				EnvVars: []string{"IGNORE_CREATORS"},
				Usage:   "Ignore documents created by these client subs.",
			},
			&cli.StringSliceFlag{
...
func runReplicant(c *cli.Context) error {
	var (
		...
		ignoreCreators     = c.StringSlice("ignore-creators")
